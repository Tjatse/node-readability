...
function Article (o) {
  ...
  Object.defineProperty(article, '$_', {
    get: function () {
      if (this.caches.dom) {
        return this.caches.dom
      }
      return (this.caches.dom = cheerio.load(o.html, co))
    }
  })
    ...
    Object.keys(options.selectors).forEach(function (prop) {
      ...
      Object.defineProperty(article, prop, {
        get: function () {
          ...
          return (this.caches[propCacheKey] = read.extract(this.$_, this.$_(sel.selector), sel.extract, this.options))
        }
      })
    })
  }
...
Article.prototype.getContent = function () {
  ...
  if (content = this.caches['article-content']) { // eslint-disable-line no-cond-assign
  ...
  return (this.caches['article-content'] = content)
}
...
Article.prototype.getTitle = function () {
  // if cache exists, return it directly.
  var title
  if (title = this.caches['article-title']) { // eslint-disable-line no-cond-assign
